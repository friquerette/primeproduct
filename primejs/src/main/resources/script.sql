...
drop database primejs;
create database primejs;
use primejs;
...
VALUES (now(), now(), 1, 'Pierre', 'Apsyre', 'pierre@primejs.com', 'admin', 'admin', '1981-04-01', /*'',*/ 'ROLE_ADMIN', 'MALE');
INSERT INTO customer (create_date, update_date, enabled, first_name, last_name, email, username, password, birthDate, /*salt,*/ role, gender)
VALUES (now(), now(), 1, 'Jeanne', 'Ubyon', 'jeanne@primejs.com', 'user', 'user', '1981-04-01', /*'',*/ 'ROLE_USER', 'FEMALE');
