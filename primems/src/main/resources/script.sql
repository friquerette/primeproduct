...
INSERT INTO customer (create_date, update_date, active, firstName, lastName, email, login, password, birthDate, /*salt,*/ admin)
VALUES (now(), now(), 1, 'Jean', 'Martin', 'jean@martin.fr', 'jmartin', '17Juin15:17', '1981-04-01', /*'',*/ 1);
